...
function markAsRead(e) {
  ...
  $.ajax({
    ...
    data: { read: true }
  }).then(sendToHotReads(url)).then(updateLinkStatus).fail(displayFailure);
}
...
function markAsUnread(e) {
  ...
  $.ajax({
    ...
    url: "/api/v1/links/" + linkId,
    data: { read: false }
  }).then(updateLinkStat).fail(displayFailure);
}
